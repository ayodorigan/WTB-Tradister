    ...
    return Scaffold(
        ...
        body: conList == null || postList == null
            ...
            : Container(
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                conList.user.userType == "Buyer" &&
                                            conList.user.shop_id == 0 ||
                                        conList.user.shop_id == null ||
                                        conList.user.shop_id == "" ||
                                        conList.user.shop_id == "0"
                                    ? Container()
                                    : Expanded(
                                        child: GestureDetector(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      ShopPage(conList.user.shop_id, userData['id'] )),
            );
                                          },
                                          child: Container(
                                            child: Column(
