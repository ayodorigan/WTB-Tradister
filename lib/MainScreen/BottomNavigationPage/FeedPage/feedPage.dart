...
class FeedPageState extends State<FeedPage> with WidgetsBindingObserver {
  ...
  Future loadPosts(int number) async {
    ...
    //     youtubeController.add(
    //       YoutubePlayerController(
    //         initialVideoId: YoutubePlayer.convertUrlToId(

    //             feedList[i].data.linkMeta != null || feedList[i].data.linkMeta == ""?
    //             feedList[i].data.linkMeta['og:url']:"https://www.youtube.com/watch?v=FH8bcj2rTh4"
    //         ),
                                                                ...
                                                                Navigator.push(
                                                                    ...
                                                                    MaterialPageRoute(
                                                                        builder: (context) => WebView(
                                                                            feedList[index].data.linkMeta['og:site_name'],
                                                                            feedList[index].data.linkMeta['og:url'])));
                                                              },
                                                              child: Container(
                                                                child: Padding(
                                                                  padding:
